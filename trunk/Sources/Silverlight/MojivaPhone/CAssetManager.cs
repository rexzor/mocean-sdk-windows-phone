...
namespace MojivaPhone
{
	internal class CAssetManager
	{
		...
		public CAssetManager(string assetsRootDir)
		{
		...
		#region "Events"
		public delegate void AssetDelegate(string alias);
		private event AssetDelegate AssetReadyEvent;
		public event AssetDelegate AssetReady
		{
			add { AssetReadyEvent += value; }
			remove { AssetReadyEvent -= value; }
		}
		private void OnAssetReady(string alias)
		{
		...
		private event AssetDelegate AssetRemovedEvent;
		public event AssetDelegate AssetRemoved
		{
			add { AssetRemovedEvent += value; }
			remove { AssetRemovedEvent -= value; }
		}
		private void OnAssetRemoved(string alias)
		{
		...
		public delegate void ResponseDelegate(string uri, string response);
		private event ResponseDelegate ResponseEvent;
		public event ResponseDelegate Response
		{
			add { ResponseEvent += value; }
			remove { ResponseEvent -= value; }
		}
		private void OnResponse(string uri, string response)
		{
